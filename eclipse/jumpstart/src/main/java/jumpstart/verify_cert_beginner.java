...
public class verify_cert_beginner {
	
	public static final String DEST = "F:\\Work\\eclipse\\pdf\\test\\";

    public static final String ROOT = "F:\\Work\\sskey\\Hun.p12";
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        verify_cert_beginner app = new verify_cert_beginner();
